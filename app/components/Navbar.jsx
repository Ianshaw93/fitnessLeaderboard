...
export default function Navbar() {
    ...
    const gold = 'bg-[#d4af37]'
    const unselected = 'bg-gray-300'
    ...
    <Link href={'/'} className="flex items-center justify-center">
        ...
        <div className="flex items-center justify-center">
            <Link href={'/workout'} className="flex items-center justify-center">
                <div className={`p-2.5 w-10 h-10 items-center fixed inline-block rounded-full ${pathname.startsWith('/workout') ? gold : unselected}`}>
                    <button>
